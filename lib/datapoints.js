module.exports = {
    ...
    PWM_PWM1:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM1'},
    PWM_PWM2:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM2'},
    PWM_PWM3:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM3'},
    PWM_PWM4:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM4'},
    PWM_PWM5:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM5'},
    PWM_PWM6:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM6'},
    PWM_PWM7:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM7'},
    PWM_PWM8:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM8'},
