module.exports = {
    ...
    PWM_PWM1:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM1', storeMap: true},
    PWM_PWM2:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM2', storeMap: true},
    PWM_PWM3:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM3', storeMap: true},
    PWM_PWM4:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM4', storeMap: true},
    PWM_PWM5:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM5', storeMap: true},
    PWM_PWM6:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM6', storeMap: true},
    PWM_PWM7:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM7', storeMap: true},
    PWM_PWM8:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM8', storeMap: true},
