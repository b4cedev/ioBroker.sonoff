...
//    PWM1:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM1', storeMap: true},
//    PWM1:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, storeMap: true},
    PWM1:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
//    PWM2:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM2', storeMap: true},
//    PWM3:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM3', storeMap: true},
//    PWM4:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM4', storeMap: true},
//    PWM5:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM5', storeMap: true},
//    PWM6:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM6', storeMap: true},
//    PWM7:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM7', storeMap: true},
//    PWM8:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023, replace: 'PWM8', storeMap: true},
//    POWER:     {type: 'boolean', role: 'switch.light',             read: true, write: true,  storeMap: true},
