module.exports = {
    ...
    PWM_PWM1:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM2:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM3:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM4:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM5:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM6:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM7:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
    PWM_PWM8:      {type: 'number',  role: 'state',                    read: true, write: true, min: 0, max: 1023},
